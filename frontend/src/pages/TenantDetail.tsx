...
export default function TenantDetail() {
  ...
  const handleStatusChange = async (newStatus: string) => {
    ...
    try {
      ...
      setTenant(prev => prev ? { ...prev, status: newStatus as any } : null)
    } catch (error) {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'INACTIVE': return <XCircle className="h-5 w-5 text-red-600" />
      case 'SUSPENDED': return <Clock className="h-5 w-5 text-yellow-600" />
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">{tenant.tenantCode}</p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-900">{getTypeLabel(tenant.type)}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-gray-900">{tenant.roleCount || 0}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="space-y-3">
              <PermissionGuard permission="users:read">
                <Link
                  to={`/users?tenant=${tenant.tenantId}`}
              ...
              <PermissionGuard permission="roles:read">
                <Link
                  to={`/roles?tenant=${tenant.tenantId}`}
                  className="w-full text-left p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors block"
                >
                  <div className="flex items-center">
              ...
              <PermissionGuard permission="audit:read">
                <Link
                  to={`/audit?tenant=${tenant.tenantId}`}
                  className="w-full text-left p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors block"
                >
                  <div className="flex items-center">
