...
const UserGroups: React.FC = () => {
  ...
  const [createForm, setCreateForm] = useState<CreateGroupForm>({ name: '', description: '' })
  const [editForm, setEditForm] = useState<CreateGroupForm>({ name: '', description: '' })
    ...
    <div className="p-6">
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new user group to organize permissions and access control.
              </DialogDescription>
            </DialogHeader>
            ...
            <DialogFooter>
              ...
              <Button onClick={createGroup} disabled={!createForm.name.trim() || loading}>
                Create Group
              </Button>
            </DialogFooter>
          </DialogContent>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      ...
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={() => deleteGroup(group.userGroupId)}>
                          Delete
                        </AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={updateGroup} disabled={!editForm.name.trim() || loading}>
              Update Group
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      {groups.length === 0 && !loading && (
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground">Get started by creating your first user group.</p>
        </div>
      )}
    </div>
  )
